...
const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full md:pt-36 pt-20 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70">
      ...
      <h1 className="md:text-home-heading-large md:leading-home-heading-large text-home-heading-small leading-home-heading-small relative font-bold text-gray-800 max-w-3xl mx-auto">

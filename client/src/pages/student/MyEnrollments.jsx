...
const MyEnrollments = () => {
  const {enrolledCourse,calculateCourseDuration,navigate,userData,fetchUserEnrolledCourses,backendurl,getToken,calculateNoOfLectures,}=useContext(AppContext);

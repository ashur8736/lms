...
const CourseDetails = () => {
  ...
  const [isAlleadyEnrolled,setIsAlreadyEnrolled]=useState(false);
    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-course-heading-large text-course-heading-small font-semibold text-gray-800">
